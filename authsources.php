...
$config = array(
    ...
    'example-userpass' => array(
        ...
        'user1:password' => array_merge($test_user_base, array(
            ...
            'http://schemas.microsoft.com/identity/claims/displayname' => 'F1 L1',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'user1@example.com',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname' => 'F1',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname' => 'F1',
        ...
        'user2:password' => array_merge($test_user_base, array(
            ...
            'http://schemas.microsoft.com/identity/claims/displayname' => 'F2 L2',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/emailaddress' => 'user2@example.com',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/givenname' => 'F2',
            'http://schemas.xmlsoap.org/ws/2005/05/identity/claims/surname' => 'F2',
